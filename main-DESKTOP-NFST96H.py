...
class Windows(Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.shared_data = {
            ...
            "hive1_wt":     [DoubleVar(self, list(Hive_Processed[list(Hive_Processed.keys())[1]]["Weight"].items())[-1][1]),
                             DoubleVar(self, min([i[1] for i in list(Hive_Processed[list(Hive_Processed.keys())[1]]["Weight"].items())])),
                             DoubleVar(self, max([i[1] for i in list(Hive_Processed[list(Hive_Processed.keys())[1]]["Weight"].items())]))],
            ...
            "hive1_humid":  [DoubleVar(self, list(Hive_Processed[list(Hive_Processed.keys())[0]]["Humidity"].items())[-1][1]),
                             DoubleVar(self, min([i[1] for i in list(Hive_Processed[list(Hive_Processed.keys())[0]]["Humidity"].items())])),
                             DoubleVar(self, max([i[1] for i in list(Hive_Processed[list(Hive_Processed.keys())[0]]["Humidity"].items())]))],
...
def main():
    windows = Windows()
    #windows.protocol("WM_DELETE_WINDOW", windows.on_closing(self))
    windows.mainloop()
